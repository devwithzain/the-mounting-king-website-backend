...
Route::post('/homeService/{id}', [HomeServiceController::class, 'update']);
...
Route::post('/advantage/{id}', [AdvantageController::class, 'update']);
...
Route::post('/serviceHero/{id}', [HeroServiceController::class, 'update']);
Route::delete('/serviceHero/{id}', [HeroServiceController::class, 'destroy']);

Route::get('/productHero', [ProductHeroController::class, 'index']);
Route::post('/productHero/{id}', [ProductHeroController::class, 'update']);
...
Route::post('/serviceRequest/{id}', [HeroRequestController::class, 'update']);
...
Route::post('/slot/{id}', [SlotController::class, 'update']);
